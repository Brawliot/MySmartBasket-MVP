...
export default function Index() {
  const { closedLists, reuseList } = useShoppingList();
    ...
    <div className="min-h-screen bg-background pb-24">
      <header className="sticky top-0 z-30 glass border-b border-divider safe-top">
        <div className="px-4 sm:px-6 py-3 sm:py-4">
          ...
          <p className="text-xs sm:text-sm text-muted-foreground mt-0.5">Listas cerradas</p>
        </div>
      </header>
          ...
          {closedLists.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-16 text-center">
              ...
              <p className="text-muted-foreground mt-1 max-w-[260px]">
                Cierra una lista en la sección Listas para verla aquí.
              </p>
            </div>
          ) : (
